...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 670),
        f"Powered By: CMTTANDHELP (@CMTTANDHELP)",
        (255, 255, 255),
        font=font,
    )
    img.save("final.png")
...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "CMTTANDHELP_Player"
    usar = user
    wew = usar.id
    try:
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                try:
                    ...
                    await lel.edit(
                        "**ꜰɪʀꜱᴛ ᴀᴅᴅ ᴍᴇ ᴀꜱ ᴀɴ ᴀᴅᴍɪɴ ᴏꜰ ʏᴏᴜʀ ɢʀᴏᴜᴘ**")
                    return
                ...
                try:
                    ...
                    await lel.edit(
                        f" **ᴍᴀɴᴜᴀʟʟʏ ᴀᴅᴅ ᴀꜱꜱᴛ ᴏʀ ᴄᴏɴᴛᴀᴄᴛ @CMTTANDHELP** ")
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/7d25711c4cbffd4615c51.jpg"
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/7d25711c4cbffd4615c51.jpg", 
                             caption="**💥🔈 Mʋsɩƈ🤞Nøω 🥀\n▶️ Ƥɑʋsɘɗ 🌷 ...**"
    )
